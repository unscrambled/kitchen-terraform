...
::Kitchen::Terraform::Client::Get = ::Class.new ::Kitchen::Terraform::Operation
::Kitchen::Terraform::Client::Get.class_eval do
  require "kitchen/terraform/client/command"
  require "kitchen/terraform/client/get/contract/command"
  require "kitchen/terraform/client/get/input/command"
  require "kitchen/terraform/operation/step/contract_failure"
  require "ostruct"

  step Model ::OpenStruct, :new
  step ::Trailblazer::Operation::Contract
    .Build constant: ::Kitchen::Terraform::Client::Get::Contract::Command
  ...
  step Nested ::Kitchen::Terraform::Client::Command,
              input: ::Kitchen::Terraform::Client::Get::Input::Command
end
