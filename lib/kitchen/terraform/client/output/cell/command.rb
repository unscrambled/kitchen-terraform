...
require "kitchen/terraform/client/output/cell"
require "kitchen/terraform/operation/cell"

::Kitchen::Terraform::Client::Output::Cell::Command =
  ::Class.new ::Kitchen::Terraform::Operation::Cell do
    property :name

    define_method :show do
      require "kitchen/terraform/client/command/cell/state"
      require "kitchen/terraform/client/output/cell/json"

      [
        "terraform", "output",
        ::Kitchen::Terraform::Client::Output::Cell::JSON.call.call,
